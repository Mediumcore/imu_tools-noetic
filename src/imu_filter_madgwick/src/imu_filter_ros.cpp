...
ImuFilterRos::ImuFilterRos(ros::NodeHandle nh, ros::NodeHandle nh_private) : nh_(nh),
    ...
    const MagMsg::ConstPtr &mag_msg)
{
  ...
  /*** Compensate for hard iron  28,458.2 nT	-3,743.5 nT	45,895.8 nT  ***/
  geometry_msgs::Vector3 mag_compensated;
  mag_compensated.x = mag_fld.x - mag_bias_.x - 0.001 * 28458.2;
  mag_compensated.y = mag_fld.y - mag_bias_.y + 0.001 * 3743.5;
  mag_compensated.z = mag_fld.z - mag_bias_.z - 0.001 * 45895.8;
